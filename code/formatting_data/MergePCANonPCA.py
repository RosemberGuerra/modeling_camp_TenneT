...
input_file_1 = Path("../../data/kmeans_result/cyfeatures_4clusters_new.csv")
input_file_2 = Path("../../data/kmeans_result/cyfeatures_4clusters_PCA_new.csv")
output_file = Path("../../data/kmeans_result/cyfeatures_4clusters_combined_new.csv")
...
common_columns = df1.columns[df1.columns != 'Name'].intersection(df2.columns)
...
df_merged = pd.merge(df1_renamed, df2_renamed, on='Name')
